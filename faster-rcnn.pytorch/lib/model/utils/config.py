...
# Number of fixed blocks during training, by default the first of all 4 
# blocks is fixed
...
# Number of fixed layers during training, by default the first of all 14 
# layers is fixed
