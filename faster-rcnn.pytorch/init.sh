...
_DATA_CARLA=${_PWD}'/../3d-tracking/data/carla/'
...
# Link GTA, KITTI and CARLA dataset to data
# get gta data
cd data/
...
# get carla data
cd ${_PWD}/data/
ln -s ${_DATA_CARLA} carla
echo "link CARLA dataset (train, val, test) to data/kitti_tracking"
