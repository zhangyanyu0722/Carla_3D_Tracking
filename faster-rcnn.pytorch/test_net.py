...
if __name__ == '__main__':
    ...
    if not os.path.exists('vis/inputs'):
        os.makedirs('vis/inputs')
        ...
        for i in range(num_images):
            ...
            for j in xrange(1, imdb.num_classes):
                ...
                if inds.numel() > 0:
                    ...
                    # print(cls_boxes, cls_centers):
                    # print(imdb.image_path_at(i), cls_centers, cls_boxes)
                    # print(imdb.image_path_at(i), cls_scores)
