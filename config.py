...
# CARLA dataset
cfg.CARLA = edict()
cfg.CARLA.FOCAL_LENGTH = 935.3074360871937
cfg.CARLA.H = 1080
cfg.CARLA.W = 1920

# CARLA object
cfg.CARLA.TRACKING = edict()
cfg.CARLA.TRACKING.CLASS_LIST = ['Car', 'Pedestrian']
cfg.CARLA.TRACKING.PATH = join(cfg.DATA_PATH, 'carla')
cfg.CARLA.TRACKING.IM_PATH = join(cfg.CARLA.TRACKING.PATH, 'train', 'image')
cfg.CARLA.TRACKING.LABEL_PATH = join(cfg.CARLA.TRACKING.PATH, 'train', 'label')
cfg.CARLA.TRACKING.PRED_PATH = join(cfg.OUTPUT_PATH, 'carla', 'train', 'pred')
cfg.CARLA.TRACKING.PKL_FILE = join(cfg.CARLA.TRACKING.LABEL_PATH, 'carla_train_labels.pkl')
cfg.CARLA.TRACKING.CLASS_PARSER = {
    'Car': 'Car',
